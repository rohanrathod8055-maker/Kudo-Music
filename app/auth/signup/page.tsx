...
import { Mail, Lock, Eye, EyeOff, User, ArrowRight, Music, Check, Loader2 } from 'lucide-react';
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.devOtp) {
                    ...
                    setSuccess(`OTP: ${data.devOtp} (dev mode)`);
                }
            } else {
    ...
    const handleVerifyOTP = async () => {
        ...
        try {
            const response = await fetch('/api/auth/verify-otp', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ email, otp: otpCode, name, password }),
            });
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                right: 0,
                bottom: 0,
                background: 'radial-gradient(ellipse at top right, #1a0a2e 0%, #0a0a0a 50%)',
                pointerEvents: 'none',
            }} />
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{
                        ...
                        {step === 'form'
                            ? 'Start your musical journey with Kudo'
                        ...
                        <form onSubmit={handleSendOTP}>
                            ...
                            <div style={{ marginBottom: '16px' }}>
                                ...
                                <div style={{ position: 'relative' }}>
                                    <User size={18} color="#6b6b6b" style={{
                                        position: 'absolute',
                                        left: '16px',
                                        top: '50%',
                            ...
                            {otp.map((digit, index) => (
                                <input
                                    ...
                                    style={{
                                        ...
                                        fontWeight: 600,
                                        backgroundColor: '#1a1a1a',
                                        border: digit ? '2px solid #7B2CBF' : '1px solid rgba(255,255,255,0.1)',
                                        borderRadius: '12px',
                                        color: '#fff',
                                        outline: 'none',
                                    }}
